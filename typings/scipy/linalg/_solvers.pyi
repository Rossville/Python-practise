...
def solve_sylvester(a, b, q): # -> _Array1D[float64] | Any:
    """
...
def solve_continuous_lyapunov(a, q): # -> _Array[tuple[()], float64] | Any:
    """
...
solve_lyapunov = ...
@_apply_over_batch(('a', 2), ('q', 2))
def solve_discrete_lyapunov(a, q, method=...): # -> _Array[tuple[()], float64] | Any:
    """
