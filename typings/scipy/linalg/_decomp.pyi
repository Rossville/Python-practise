...
def eig(a, b=..., left=..., right=..., overwrite_a=..., overwrite_b=..., check_finite=..., homogeneous_eigvals=...): # -> NDArray[Any] | NDArray[float64] | tuple[NDArray[Any] | NDArray[float64] | Any, NDArray[float64] | NDArray[Any], NDArray[float64] | NDArray[Any]] | tuple[NDArray[Any] | NDArray[float64] | Any, NDArray[float64] | NDArray[Any]] | tuple[NDArray[Any] | Any, NDArray[Any] | Any, NDArray[Any] | Any] | tuple[NDArray[Any] | Any, NDArray[Any] | Any]:
    """
...
def eig_banded(a_band, lower=..., eigvals_only=..., overwrite_a_band=..., select=..., select_range=..., max_ev=..., check_finite=...): # -> NDArray[Any] | tuple[NDArray[Any], NDArray[float64] | NDArray[Any]] | tuple[Any, Any]:
    """
...
def eigvalsh_tridiagonal(d, e, select=..., select_range=..., check_finite=..., tol=..., lapack_driver=...): # -> NDArray[Incomplete] | NDArray[float64] | tuple[NDArray[Incomplete] | NDArray[float64], ndarray[Any, dtype[float64]] | NDArray[float64]] | tuple[Any, Any]:
    """
...
@_apply_over_batch(('d', 1), ('e', 1))
def eigh_tridiagonal(d, e, eigvals_only=..., select=..., select_range=..., check_finite=..., tol=..., lapack_driver=...): # -> NDArray[Incomplete] | NDArray[float64] | tuple[NDArray[Incomplete] | NDArray[float64], ndarray[Any, dtype[float64]] | NDArray[float64]] | tuple[Any, Any]:
    """
    Solve eigenvalue problem for a real symmetric tridiagonal matrix.
...
def hessenberg(a, calc_q=..., overwrite_a=..., check_finite=...): # -> _Array[tuple[int, int], float64] | tuple[_Array[tuple[int, int], float64], _Array[tuple[int, int], float64]] | tuple[NDArray[float64] | NDArray[Any], NDArray[float64]] | NDArray[float64] | NDArray[Any] | tuple[NDArray[Any], Any]:
    """
...
def cdf2rdf(w, v): # -> tuple[ndarray[tuple[int, int], dtype[float64]], Any]:
    """
