...
def expm(A): # -> NDArray[Incomplete] | NDArray[Any] | ndarray[tuple[()], dtype[float64] | dtype[floating[_32Bit]]]:
...
def sqrtm(A, disp=..., blocksize=...): # -> NDArray[Incomplete] | tuple[Any, Any | floating[Any] | float]:
    """
...
@_apply_over_batch(('A', 2))
def signm(A, disp=...): # -> Any | NDArray[float64] | tuple[NDArray[float64] | Any, Any | floating[Any] | float | int]:
    """
