...
class VectorFunction:
    ...
    def jac(self, x): # -> int_ | numpy.bool[builtins.bool] | float64 | ndarray[tuple[int], dtype[int_ | numpy.bool[builtins.bool] | float64]] | ndarray[tuple[int, int], dtype[int_ | numpy.bool[builtins.bool] | float64]] | ndarray[_AnyShape, dtype[int_ | numpy.bool[builtins.bool] | float64]] | csr_matrix | csr_array | <subclass of _csr_base* and sparray> | _csr_base | object | LinearOperator | _Array1D[float64] | _Array[tuple[int, int], float64] | NDArray[float64]:
        ...
