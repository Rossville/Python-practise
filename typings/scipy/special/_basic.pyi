...
def diric(x, n): # -> _Array[tuple[()], Any]:
...
def riccati_jn(n, x): # -> tuple[ndarray[_AnyShape, dtype[float64]], ndarray[_AnyShape, dtype[float64]]]:
...
def riccati_yn(n, x): # -> tuple[ndarray[_AnyShape, dtype[float64]], ndarray[_AnyShape, dtype[float64]]]:
...
def lpmn(m, n, z): # -> tuple[ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]]]:
...
def clpmn(m, n, z, type=...): # -> tuple[ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]]]:
...
def lqmn(m, n, z): # -> tuple[ndarray[_AnyShape, dtype[complex128]] | ndarray[_AnyShape, dtype[float64]], ndarray[_AnyShape, dtype[complex128]] | ndarray[_AnyShape, dtype[float64]]]:
...
def lqn(n, z): # -> tuple[ndarray[_AnyShape, dtype[complex128]] | ndarray[_AnyShape, dtype[float64]], ndarray[_AnyShape, dtype[complex128]] | ndarray[_AnyShape, dtype[float64]]]:
