...
def prepare_input(x, y, axis, dydx=...): # -> tuple[ndarray[_AnyShape, dtype[Any]], NDArray[Any], NDArray[Any], Any, NDArray[Any] | None]:
...
def pchip_interpolate(xi, yi, x, der=..., axis=...): # -> ndarray[tuple[()], dtype[complex128 | float64]] | list[ndarray[tuple[()], dtype[complex128 | float64]] | Any]:
    """
