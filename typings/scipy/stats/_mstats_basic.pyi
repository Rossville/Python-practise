...
def find_repeats(arr): # -> tuple[NDArray[float64], NDArray[signedinteger[_NBitIntP]]] | tuple[ndarray[_AnyShape, dtype[float64]], ndarray[_AnyShape, dtype[Any]]]:
...
def rankdata(data, axis=..., use_missing=...): # -> _Array1D[Any]:
...
def moment(a, moment=..., axis=...): # -> float64 | Any:
    """
