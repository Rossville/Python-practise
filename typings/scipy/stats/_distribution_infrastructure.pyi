...
class _Interval(_Domain):
    ...
    def get_numerical_endpoints(self, parameter_values): # -> tuple[Array | Any, Array | Any]:
...
class UnivariateDistribution(_ProbabilityDistribution):
    ...
    def cdf(self, x, y=..., /, *, method=...): # -> Callable[..., Any] | Callable[..., ndarray[_AnyShape, dtype[Any]] | Any] | Callable[..., _Array[tuple[()], float64 | Any] | Any | ndarray[_AnyShape, dtype[Any]]] | Callable[..., ndarray[_AnyShape, dtype[Any]]]:
        ...
...
class Mixture(_ProbabilityDistribution):
    ...
    def support(self): # -> tuple[ndarray[tuple[()], dtype[Any]] | NDArray[Any], ndarray[tuple[()], dtype[Any]] | NDArray[Any]]:
        ...
