...
class _ExpmPadeHelper:
    ...
    @property
    def d4_tight(self): # -> floating[Any] | float64:
        ...
    
    @property
    def d6_tight(self): # -> floating[Any] | float64:
        ...
    
    @property
    def d8_tight(self): # -> floating[Any] | float64:
        ...
    
    @property
    def d10_tight(self): # -> floating[Any] | float64:
        ...
    
    @property
    def d4_loose(self): # -> floating[Any] | float64 | Any:
        ...
    
    @property
    def d6_loose(self): # -> floating[Any] | float64 | Any:
        ...
    
    @property
    def d8_loose(self): # -> floating[Any] | float64 | Any:
        ...
    
    @property
    def d10_loose(self): # -> floating[Any] | float64 | Any:
        ...
...
def expm(A): # -> ndarray[_AnyShape, dtype[Any]] | ndarray[Any, dtype[Any]] | NDArray[Any] | csc_array | Any | _NotImplementedType:
    """
...
def matrix_power(A, power): # -> coo_array | coo_matrix | dia_array | Any | dia_matrix | _NotImplementedType | ndarray[tuple[int], dtype[Any]] | ndarray[tuple[int], Any] | ndarray[tuple[int, int], dtype[Any]] | ndarray[tuple[int, int], Any] | NDArray[Any] | matrix[Any, Any] | matrix[_2D, dtype[Any]]:
    """
