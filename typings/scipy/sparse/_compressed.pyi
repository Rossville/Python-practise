...
class _cs_matrix(_data_matrix, _minmax_mixin, IndexMixin):
    ...
    def count_nonzero(self, axis=...): # -> intp | NDArray[intp] | NDArray[Any]:
        ...
    ...
    def diagonal(self, k=...): # -> ndarray[tuple[int], dtype[float64 | int_ | numpy.bool[builtins.bool]]] | _Array1D[float64]:
        ...
    
    def sum(self, axis=..., dtype=..., out=...): # -> matrix[_2D, Incomplete] | Any | NDArray[Any] | matrix[Any, Any] | matrix[_2D, dtype[Any]]:
